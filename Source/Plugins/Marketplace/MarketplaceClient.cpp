...
void MarketplaceClient::ensure_default_catalog_if_empty()
{
    ...
    m_entries = {
        ...
        {
            .id = "zde.theme.one-dark-pro",
            .name = "One Dark Pro",
            .version = "1.0.0",
            .description = "Atom's iconic One Dark theme for ZDE Studio and Visual Studio Code",
            .publisher = "Binaryify",
            .repository_url = "https://github.com/Binaryify/OneDark-Pro.git",
            .download_url = "",
            .icon_url = "https://raw.githubusercontent.com/Binaryify/OneDark-Pro/master/images/icon.png",
            .sha256 = "",
            .category = "themes",
            .tags = {"theme", "dark", "one dark", "vscode", "github"},
            .downloads = "8.2M",
            .rating = "4.9"
        },
        {
            .id = "zde.theme.dracula",
            .name = "Dracula Official",
            .version = "2.24.2",
            .description = "Official Dracula Theme. A dark theme for ZDE Studio and 330+ apps",
            .publisher = "Dracula Theme",
            .repository_url = "https://github.com/dracula/visual-studio-code.git",
            .download_url = "",
            .icon_url = "https://raw.githubusercontent.com/dracula/visual-studio-code/master/images/icon.png",
            .sha256 = "",
            .category = "themes",
            .tags = {"theme", "dracula", "dark", "vscode", "github"},
            .downloads = "6.1M",
            .rating = "4.9"
        },
        {
            .id = "zde.theme.catppuccin",
            .name = "Catppuccin for ZDE",
            .version = "3.16.0",
            .description = "Soothing pastel theme for ZDE Studio and VSCode",
            .publisher = "Catppuccin",
            .repository_url = "https://github.com/catppuccin/vscode.git",
            .download_url = "",
            .icon_url = "https://raw.githubusercontent.com/catppuccin/vscode/main/assets/icon.png",
            .sha256 = "",
            .category = "themes",
            .tags = {"theme", "catppuccin", "pastel", "dark", "light", "github"},
            .downloads = "3.9M",
            .rating = "4.9"
        },
        {
            .id = "zde.theme.tokyo-night",
            .name = "Tokyo Night",
            .version = "1.0.8",
            .description = "A clean, dark Visual Studio Code theme that celebrates the lights of Downtown Tokyo",
            .publisher = "enkia",
            .repository_url = "https://github.com/enkia/tokyo-night-vscode-theme.git",
            .download_url = "",
            .icon_url = "https://raw.githubusercontent.com/enkia/tokyo-night-vscode-theme/master/icons/tokyo-night.png",
            .sha256 = "",
            .category = "themes",
            .tags = {"theme", "tokyo night", "dark", "vscode", "github"},
            .downloads = "2.4M",
            .rating = "4.8"
        },
        {
            ...
            .name = "GitHub Theme",
            .version = "6.3.4",
            .description = "GitHub classic and dark themes for ZDE Studio",
            .publisher = "GitHub",
            .repository_url = "https://github.com/primer/github-vscode-theme.git",
            .download_url = "",
            .icon_url = "https://raw.githubusercontent.com/primer/github-vscode-theme/main/icons/icon.png",
            .sha256 = "",
            .category = "themes",
            .tags = {"theme", "github", "light", "dark", "vscode"},
            .downloads = "10M",
            .rating = "4.7"
        }
    };
