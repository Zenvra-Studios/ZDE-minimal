...
struct StudioEditorMetrics final
{
    ...
    static constexpr float editor_tab_minimum_width = 120.0F;
    static constexpr float editor_tab_maximum_width = 520.0F;
    ...
    static constexpr float titlebar_window_controls_width = 664.0F;
};
