    ...
    std::span<const std::filesystem::path> dropped_paths)
{
    ...
    for (const std::filesystem::path& file : EditorDropModel::collect_files(dropped_paths))
    {
...
bool EditorController::create_buffer()
{
...
std::optional<EditorAction> EditorController::action_from_command_id(
...
bool EditorController::execute_input(
...
const TextDocumentModel* EditorController::get_active_document() const noexcept
{
    return m_session.get_active_document();
}
