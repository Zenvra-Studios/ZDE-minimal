...
public:
  ...
  get_icon_asset_root() const noexcept;
  [[nodiscard]] const std::filesystem::path &
  get_icon_asset_root() const noexcept;
  ...
  [[nodiscard]] bool
  handle_workspace_pointer_press(float point_x, float point_y, int client_width,
                                 int client_height, float content_top,
                                 bool extend_selection, Time event_time,
                                 std::string &command_out);
  [[nodiscard]] bool handle_workspace_pointer_move(float point_x, float point_y,
                                                   int client_width,
                                                   int client_height,
                                                   float content_top) noexcept;
  [[nodiscard]] bool handle_workspace_pointer_drag(float point_x, float point_y,
                                                   int client_width,
                                                   int client_height,
                                                   float content_top);
  [[nodiscard]] bool handle_workspace_pointer_release() noexcept;
  [[nodiscard]] bool handle_workspace_scroll(std::ptrdiff_t line_delta,
                                             int client_width,
                                             int client_height,
                                             float content_top) noexcept;
  [[nodiscard]] bool handle_editor_input(UI::Editor::EditorInputCommand command,
                                         bool extend_selection);
  [[nodiscard]] bool handle_editor_action(UI::Editor::EditorAction action);
  [[nodiscard]] std::optional<bool>
  handle_editor_command(std::string_view command_id);
  [[nodiscard]] std::optional<bool>
  is_editor_command_enabled(std::string_view command_id) const noexcept;
  ...
  [[nodiscard]] bool handle_tool_sidebar_scroll(std::ptrdiff_t line_delta,
                                                int client_width,
                                                int client_height,
                                                float content_top) noexcept;
  [[nodiscard]] bool is_editor_focused() const noexcept;
  [[nodiscard]] bool is_terminal_focused() const noexcept;
  [[nodiscard]] bool is_activity_bar_point(float point_x, float point_y,
                                           int client_width, int client_height,
                                           float content_top) const noexcept;
  [[nodiscard]] bool is_tab_bar_point(float point_x, float point_y,
                                      int client_width, int client_height,
                                      float content_top) const noexcept;
  [[nodiscard]] bool is_editor_point(float point_x, float point_y,
                                     int client_width, int client_height,
                                     float content_top) const noexcept;
  [[nodiscard]] bool is_scrollbar_point(float point_x, float point_y,
                                        int client_width, int client_height,
                                        float content_top) const noexcept;
  [[nodiscard]] bool is_minimap_point(float point_x, float point_y,
                                      int client_width, int client_height,
                                      float content_top) const noexcept;
  [[nodiscard]] bool is_terminal_point(float point_x, float point_y,
                                       int client_width, int client_height,
                                       float content_top) const noexcept;
  [[nodiscard]] bool is_tool_sidebar_point(float point_x, float point_y,
                                           int client_width, int client_height,
                                           float content_top) const noexcept;
  [[nodiscard]] bool
  is_terminal_resize_handle_point(float point_x, float point_y,
                                  int client_width, int client_height,
                                  float content_top) const noexcept;
  ...
  void
  render(Window window_handle, int client_width, int client_height,
  ...
  [[nodiscard]] PopupMenuGeometry calculate_popup_geometry(
      const UI::Chrome::WindowChromeLayoutResult &chrome_layout,
      std::size_t menu_index, bool opened_from_overflow = false) const noexcept;
...
private:
  ...
  allocate_color(const UI::Theme::Color &color) const;
  void fill_rectangle(Drawable drawable, const UI::Rect &rectangle,
                      unsigned long color, int radius = 0) const;
  void draw_rectangle(Drawable drawable, const UI::Rect &rectangle,
                      unsigned long color, int radius = 0) const;
  void draw_centered_text(Drawable drawable, std::string_view text,
                          const UI::Rect &rectangle,
                          const std::string &color) const;
  void draw_text(Drawable drawable, std::string_view text,
                 const UI::Rect &rectangle, float left_padding,
                 const std::string &color) const;
  void
  draw_window_control(Drawable drawable, const UI::Rect &bounds,
  ...
  void draw_popup_menu(
      ...
      const CommandStateQueryCallback &command_state_query_callback) const;
  void
  draw_overflow_menu(Drawable drawable,
                     const UI::Chrome::WindowChromeLayoutResult &chrome_layout,
                     const ChromeInteractionState &interaction_state) const;
