...
void ToolSidebar::render(
  ...
  surface.draw_line(drawable, round_to_int(panel.right() - scale),
                    ...
                    round_to_int(panel.bottom()), surface.m_pixels.border);
  ...
  for (std::size_t item_index = first; item_index < end; ++item_index) {
    ...
    if (item.directory) {
      ...
      surface.draw_svg_icon(drawable, chevron_path, arrow_x, arrow_y,
      ...
      surface.draw_svg_icon(
          drawable, folder_path, round_to_int(indent_x + 19.0F * scale),
